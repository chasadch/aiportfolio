          ...
          >
            <div className="space-y-4">
              ...
              >
                HI, I AM
                <br />
                <span className="text-lime-400">MUHAMMAD ASAD ARSHAD.</span>
              </motion.h1>
              ...
              >
                A Pakistan based AI/ML developer passionate about building intelligent solutions and user-friendly applications.
              </motion.p>
            </div>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-lg font-semibold flex items-center gap-2 overflow-hidden group"
              >
                <motion.div
              ...
              >
                ...
                <div className="text-center space-y-4">
                  <motion.div
                    ...
                    className="w-24 h-24 bg-lime-400 rounded-full flex items-center justify-center mx-auto"
                  >
                    <Brain className="w-12 h-12 text-black" />
                  </motion.div>
                  <div className="text-white">
                    <p className="text-lg font-semibold">AI/ML Developer</p>
